...
import com.igobrilhante.github.commons.{CacheHeader, Logging}
import com.igobrilhante.github.models.{AppException, UnexpectedErrorException}
import com.typesafe.config.ConfigFactory

private[impl] trait GitHubAPIHandlers {
  this: Logging =>
